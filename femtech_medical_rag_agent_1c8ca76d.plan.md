...
4. `app/db/models.py` - SQLAlchemy + pgvector models
5. `ingestion/pipeline.py` - Ingestion orchestrator
6. `agent/graph.py` - LangGraph workflow

---

## Budget Estimation

- Azure OpenAI (LLM + Embeddings): ~$100-150 total for MVP
- Azure Document Intelligence: ~$80-100 for 500 papers
- GCP Cloud SQL (small instance): ~$20-30/month